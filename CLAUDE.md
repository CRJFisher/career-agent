...
- After each task, you should update the backlog.md file with any findings, decisions, or other relevant information.
- If there are any follow-on tasks that should be done later, add those to backlog.
- Then, you should commit but *do not push* the changes.
